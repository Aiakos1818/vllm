...
def flashinfer_sampler_supported() -> bool:
    ...
    if not FlashInferBackend.supports_compute_capability(capability):
        # Allow local SM75/2080 Ti deployments that have validated FlashInfer
        # top-p/top-k sampling with the pinned FlashInfer runtime. The generic
        # FlashInfer attention backend gate is stricter than this sampler path
        # needs on Qwopus/Qwen3.5 FP8.
